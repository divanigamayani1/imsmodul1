...
MySQL - 10.1.28-MariaDB : Database - g0pqaa3ig2
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`g0pqaa3ig2` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
insert  into `tb_invoice`(`id_invoice`,`total_transaksi`,`status`) values (1,500000,'1'),(2,1000000,'1');
